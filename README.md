# Projeto Sprint 3 - Web Development : Resenha ON
...
Para rodar este projeto na sua máquina, abra o terminal na pasta raiz e execute:
```bash
npm install
```
...
* Não há autenticação necessária neste projeto.
* Para testar o **localStorage** e a **função Math**, basta preencher o formulário na seção "Contato" ao final da página e clicar em "Enviar mensagem".
